<?php
    ...
    elseif(isset($_POST['submit_new_reg'])) {
        ...
        $full_name = decodeFrom($full_name);
        ...
        <form method="post" name="<?php echo $form_type; ?>" action="<?php echo $form_action; ?>">
            ...
            <div class="row form-group">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 mb-20">
                    ...
                    <input type="text" name="t_issueDate" value="<?php echo $permit_issue_date; ?>" data-field="date" data-format="dd-MMM-yyyy" readonly class="validates-as-required form-control" id="t_issueDate" />
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4 mb-20">
                    <label class="text-black" for="t_expirationDate">Expiration Date <span>*</span></label>
                    <input type="text" name="t_expirationDate" value="<?php echo $permit_expiry; ?>" data-field="date" data-format="dd-MMM-yyyy" readonly class="validates-as-required form-control" id="t_expirationDate" />
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4 mb-20">
                    <label class="text-black" for="t_Dob">Date of Birth <span>*</span></label>
                    <input type="text" name="t_Dob" value="<?php echo $date_of_birth; ?>" data-field="date" data-format="dd-MMM-yyyy" readonly class="validates-as-required form-control" id="t_Dob" />
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4 mb-20">
                    <label class="text-black" for="t_email">Email ID <span>*</span></label>
                    <input type="email" name="t_email" value="<?php echo $email; ?>" class="validates-as-required form-control" id="t_email" />
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 mb-20">
                    ...
                    <input type="text" name="t_wdys" value="<?php echo $when2start; ?>" data-field="date" data-format="dd-MMM-yyyy" readonly class="form-control" id="t_wdys" aria-invalid="false" />
                </div>
            </div>
